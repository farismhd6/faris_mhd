  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link text-dark mx-2" href="AddAppointment.jsp">Appointment</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-dark mx-2" href="patient.jsp">Patient</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-dark mx-2" href="AddPayment.jsp">Payment</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-dark mx-2" href="addStaff.jsp">Staff</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-dark mx-2" href="AddTestResult.jsp">TestResult</a>
        </li>
      </ul>
    </div>
  </div>
